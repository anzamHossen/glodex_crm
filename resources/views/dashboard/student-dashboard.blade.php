                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center justify-content-center gap-2 my-2 py-1">
                                        ...
                                        <h3 class="mb-0 fw-bold">{{ $studentTotalCountries ?? 0 }}</h3>
                                    </div>
                                </div>
                            </div>
                        </div><!-- end col -->
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center justify-content-center gap-2 my-2 py-1">
                                        ...
                                        <h3 class="mb-0 fw-bold">{{ $studentTotalUniversities ?? 0 }}</h3>
                                    </div>
                                </div>
                            </div>
                        </div><!-- end col -->
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center justify-content-center gap-2 my-2 py-1">
                                        ...
                                        <h3 class="mb-0 fw-bold">{{ $studentTotalCourses ?? 0}}</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center justify-content-center gap-2 my-2 py-1">
                                        ...
                                        <h3 class="mb-0 fw-bold">{{ $studentTotalApplications ?? 0}}</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center justify-content-center gap-2 my-2 py-1">
                                        ...
                                        <h3 class="mb-0 fw-bold">{{ $studentInProgressApplication ?? 0 }}</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center justify-content-center gap-2 my-2 py-1">
                                        ...
                                        <h3 class="mb-0 fw-bold">{{ $studentAppliedApplication ?? 0 }}</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center justify-content-center gap-2 my-2 py-1">
                                        ...
                                        <h3 class="mb-0 fw-bold">{{ $studentTotalVisaGranted ?? 0}}</h3>
                                    </div>
                                </div>
                            </div>
                        </div><!-- end col -->
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center justify-content-center gap-2 my-2 py-1">
                                        ...
                                        <h3 class="mb-0 fw-bold">{{ $studentTotalVisaRejected ?? 0}}</h3>
                                    </div>
                                </div>
                            </div>
                        </div><!-- end col -->
