                                        ...
                                        <div class="row pb-4">
                                                ...
                                                <div class="info-card">
                                                    ...
                                                    <div class="info-value">
                                                        <a href="#" class="text-decoration-none text-white">
                                                            <i class="bi bi-envelope"></i>{{ $universityDetails->admission_email ?? 'Not Added'}}
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="info-card">
                                                    ...
                                                    <div class="info-value">
                                                        <i class="bi bi-telephone"></i>{{$universityDetails->admission_phone ?? 'Not Added'}}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="info-card">
                                                    ...
                                                    <div class="info-value">
                                                        <a href="#" target="_blank" class="text-decoration-none text-white">
                                                            <i class="bi bi-globe"></i>{{ $universityDetails->website_link ?? 'Not Added'}}
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="info-card">
                                                    ...
                                                    <div class="info-value">
                                                        <i class="bi bi-pin-map"></i>{{ $universityDetails->address ?? 'Not Added'}}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
