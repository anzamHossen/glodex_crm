                        ...
                        <div class="card-body">
                            ...
                            <div class="row  pb-4">
                                <div class="col-12 col-sm-6 col-md-6 col-lg-4 col-xl-4 col-xxl-3 mb-3">
                                    <div class="course-list-card border position-relative h-100">
                                        {{-- 3 dots --}}
                                        ...
                                        <div class="card-header-section ">
                                            ...
                                            <div class="university-info">
                                                <div class="university-details">
                                                    ...
                                                    <p><i class="ti ti-geo-alt-fill"></i> United States</p>
                                                </div>
                                        ...
                                        <div class="card-body-section">
                                            <div class="info-grid">
                                                <div class="info-item">
                                                    <h4 class="">
                                                        <i class="ti ti-mortarboard-fill"></i> Program Level
                                                    </h4>
                                                ...
                                                <div class="info-item">
                                                    <h4 class="">
                                                        <i class="ti ti-calendar-check"></i> Intake Month
                                                    </h4>
                                            ...
                                            <div class="info-grid">
                                                <div class="info-item">
                                                    <h4 class="">
                                                        <i class="ti ti-cash-coin"></i> Application Fees
                                                    </h4>
                                                ...
                                                <div class="info-item">
                                                    <h4 class="">
                                                        <i class="ti ti-currency-dollar"></i> Tuition Fees/Year
                                                    </h4>
                                            ...
                                            <div class="info-grid">
                                                <div class="info-item">
                                                    <h4 class="">
                                                        <i class="ti ti-clock-history"></i> Program Length
                                                    </h4>
